...
TEST(BraveQueryFilter, FilterQueryTrackers) {
  ...
  EXPECT_EQ(query_filter::MaybeApplyQueryStringFilter(
                GURL("https://express.com"), GURL("https://express.com"),
  ...
  EXPECT_EQ(query_filter::MaybeApplyQueryStringFilter(
                GURL("https://test.com"), GURL("https://express.com"),
                GURL("https://test.com/?gclid=123"), "GET", false),
            GURL("https://test.com/"));
  ...
  EXPECT_FALSE(query_filter::MaybeApplyQueryStringFilter(
      GURL("https://express.com"), GURL("https://express.com"), GURL(), "GET",
      false));
  ...
  EXPECT_FALSE(query_filter::MaybeApplyQueryStringFilter(
      GURL("https://express.com"), GURL("https://test.com"),
      GURL("https://test.com/?gclid=123"), "GET", false));
