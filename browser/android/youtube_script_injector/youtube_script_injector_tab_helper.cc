...
constexpr char16_t kYoutubePipNavigationFix[] =
    ...
    (async function() {
        ...
        document.body.style.border = '0.1px solid red';
        ...
        const handleEnterPiP = async (event) => {
            ...
            if (videoEl) videoEl.style.border = '0.1px solid blue';
        };
        ...
        const handleLeavePiP = async (event) => {
            ...
            if (videoEl) videoEl.style.border = '0.1px solid green';
        ...
        const attachListeners = async (vid) => {
            ...
            videoEl.style.border = '0.1px solid pink';
