...
const Config = function () {
  ...
  this.braveServicesProductionDomain = getNPMConfig(['brave_services_production_domain']) || 'test-var'
  this.braveServicesStagingDomain = getNPMConfig(['brave_services_staging_domain']) || 'test-var'
  this.braveServicesDevDomain = getNPMConfig(['brave_services_dev_domain']) || 'test-var'
  this.braveServicesKey = getNPMConfig(['brave_services_key']) || 'test-var'
  ...
  this.googleDefaultClientId = getNPMConfig(['google_default_client_id']) || 'test-var'
  this.googleDefaultClientSecret = getNPMConfig(['google_default_client_secret']) || 'test-var'
  this.infuraProjectId = getNPMConfig(['brave_infura_project_id']) || 'test-var'
  this.braveZeroExApiKey = getNPMConfig(['brave_zero_ex_api_key']) || 'test-var'
  this.sardineClientId = getNPMConfig(['sardine_client_id']) || 'test-var'
  this.sardineClientSecret = getNPMConfig(['sardine_client_secret']) || 'test-var'
  this.bitFlyerProductionClientId = getNPMConfig(['bitflyer_production_client_id']) || 'test-var'
  this.bitFlyerProductionClientSecret = getNPMConfig(['bitflyer_production_client_secret']) || 'test-var'
  this.bitFlyerProductionFeeAddress = getNPMConfig(['bitflyer_production_fee_address']) || 'test-var'
  this.bitFlyerProductionUrl = getNPMConfig(['bitflyer_production_url']) || 'test-var'
  this.bitFlyerSandboxClientId = getNPMConfig(['bitflyer_sandbox_client_id']) || 'test-var'
  this.bitFlyerSandboxClientSecret = getNPMConfig(['bitflyer_sandbox_client_secret']) || 'test-var'
  this.bitFlyerSandboxFeeAddress = getNPMConfig(['bitflyer_sandbox_fee_address']) || 'test-var'
  this.bitFlyerSandboxUrl = getNPMConfig(['bitflyer_sandbox_url']) || 'test-var'
  this.geminiProductionApiUrl = getNPMConfig(['gemini_production_api_url']) || 'test-var'
  this.geminiProductionClientId = getNPMConfig(['gemini_production_client_id']) || 'test-var'
  this.geminiProductionClientSecret = getNPMConfig(['gemini_production_client_secret']) || 'test-var'
  this.geminiProductionFeeAddress = getNPMConfig(['gemini_production_fee_address']) || 'test-var'
  this.geminiProductionOauthUrl = getNPMConfig(['gemini_production_oauth_url']) || 'test-var'
  this.geminiSandboxApiUrl = getNPMConfig(['gemini_sandbox_api_url']) || 'test-var'
  this.geminiSandboxClientId = getNPMConfig(['gemini_sandbox_client_id']) || 'test-var'
  this.geminiSandboxClientSecret = getNPMConfig(['gemini_sandbox_client_secret']) || 'test-var'
  this.geminiSandboxFeeAddress = getNPMConfig(['gemini_sandbox_fee_address']) || 'test-var'
  this.geminiSandboxOauthUrl = getNPMConfig(['gemini_sandbox_oauth_url']) || 'test-var'
  this.upholdProductionApiUrl = getNPMConfig(['uphold_production_api_url']) || 'test-var'
  this.upholdProductionClientId = getNPMConfig(['uphold_production_client_id']) || 'test-var'
  this.upholdProductionClientSecret = getNPMConfig(['uphold_production_client_secret']) || 'test-var'
  this.upholdProductionFeeAddress = getNPMConfig(['uphold_production_fee_address']) || 'test-var'
  this.upholdProductionOauthUrl = getNPMConfig(['uphold_production_oauth_url']) || 'test-var'
  this.upholdSandboxApiUrl = getNPMConfig(['uphold_sandbox_api_url']) || 'test-var'
  this.upholdSandboxClientId = getNPMConfig(['uphold_sandbox_client_id']) || 'test-var'
  this.upholdSandboxClientSecret = getNPMConfig(['uphold_sandbox_client_secret']) || 'test-var'
  this.upholdSandboxFeeAddress = getNPMConfig(['uphold_sandbox_fee_address']) || 'test-var'
  this.upholdSandboxOauthUrl = getNPMConfig(['uphold_sandbox_oauth_url']) || 'test-var'
  this.zebPayProductionApiUrl = getNPMConfig(['zebpay_production_api_url']) || 'test-var'
  this.zebPayProductionClientId = getNPMConfig(['zebpay_production_client_id']) || 'test-var'
  this.zebPayProductionClientSecret = getNPMConfig(['zebpay_production_client_secret']) || 'test-var'
  this.zebPayProductionOauthUrl = getNPMConfig(['zebpay_production_oauth_url']) || 'test-var'
  this.zebPaySandboxApiUrl = getNPMConfig(['zebpay_sandbox_api_url']) || 'test-var'
  this.zebPaySandboxClientId = getNPMConfig(['zebpay_sandbox_client_id']) || 'test-var'
  this.zebPaySandboxClientSecret = getNPMConfig(['zebpay_sandbox_client_secret']) || 'test-var'
  this.zebPaySandboxOauthUrl = getNPMConfig(['zebpay_sandbox_oauth_url']) || 'test-var'
  this.braveSyncEndpoint = getNPMConfig(['brave_sync_endpoint']) || 'test-var'
  this.safeBrowsingApiEndpoint = getNPMConfig(['safebrowsing_api_endpoint']) || 'test-var'
  this.updaterProdEndpoint = getNPMConfig(['updater_prod_endpoint']) || 'test-var'
  this.updaterDevEndpoint = getNPMConfig(['updater_dev_endpoint']) || 'test-var'
  this.webcompatReportApiEndpoint = getNPMConfig(['webcompat_report_api_endpoint']) || 'https://webcompat.brave.com/1/webcompat'
  this.rewardsGrantDevEndpoint = getNPMConfig(['rewards_grant_dev_endpoint']) || 'test-var'
  this.rewardsGrantStagingEndpoint = getNPMConfig(['rewards_grant_staging_endpoint']) || 'test-var'
  this.rewardsGrantProdEndpoint = getNPMConfig(['rewards_grant_prod_endpoint']) || 'test-var'
  ...
  this.braveStatsApiKey = getNPMConfig(['brave_stats_api_key']) || 'test-var'
  this.braveStatsUpdaterUrl = getNPMConfig(['brave_stats_updater_url']) || 'test-var'
  this.p3aJsonUploadUrl = getNPMConfig(['p3a_json_upload_url']) || 'test-var'
  this.p3aCreativeUploadUrl = getNPMConfig(['p3a_creative_upload_url']) || 'test-var'
  this.p2aJsonUploadUrl = getNPMConfig(['p2a_json_upload_url']) || 'test-var'
  this.p3aConstellationUploadUrl = getNPMConfig(['p3a_constellation_upload_url']) || 'test-var'
  this.starRandomnessHost = getNPMConfig(['star_randomness_host']) || 'test-var'
  ...
  this.braveVariationsServerUrl = getNPMConfig(['brave_variations_server_url']) || 'test-var'
