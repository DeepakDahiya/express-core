...
Config.prototype.buildArgs = function () {
  ...
  if (this.targetOS === 'android') {
    ...
    if (!this.isReleaseBuild()) {
      ...
      args.chrome_public_manifest_package = 'com.browser.express_default'
    } else if (this.channel === '') {
      args.android_channel = 'stable'
      args.chrome_public_manifest_package = 'com.browser.express'
    } else if (this.channel === 'beta') {
      args.chrome_public_manifest_package = 'com.browser.express_beta'
    } else if (this.channel === 'dev') {
      args.chrome_public_manifest_package = 'com.browser.express_dev'
    } else if (this.channel === 'nightly') {
      args.android_channel = 'canary'
      args.chrome_public_manifest_package = 'com.browser.express_nightly'
    }
