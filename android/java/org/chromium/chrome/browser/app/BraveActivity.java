...
public abstract class BraveActivity extends ChromeActivity
     ...
     */
    public static final String CHANNEL_ID = "com.browser.express";
    ...
    public void setCustomFilterList() {
        ...
        if(boolInString == null || !boolInString.equals("true") ){
            ...
            urlList.add("https://easylist-downloads.adblockplus.org/Liste_AR.txt");
            urlList.add("https://raw.githubusercontent.com/blocklistproject/Lists/master/adguard/porn-ags.txt");
            urlList.add("https://stanev.org/abp/adblock_bg.txt");
            urlList.add("https://easylist-downloads.adblockplus.org/easylistchina.txt");
            urlList.add("https://raw.githubusercontent.com/cjx82630/cjxlist/master/cjx-annoyance.txt");
            urlList.add("https://filters.adtidy.org/extension/ublock/filters/224.txt");
            urlList.add("https://raw.githubusercontent.com/tomasko126/easylistczechandslovak/master/filters.txt");
            urlList.add("https://easylist-downloads.adblockplus.org/easylistgermany.txt");
            urlList.add("https://adblock.ee/list.php");
            urlList.add("https://raw.githubusercontent.com/finnish-easylist-addition/finnish-easylist-addition/gh-pages/Finland_adb.txt");
            urlList.add("https://filters.adtidy.org/extension/ublock/filters/16.txt");
            urlList.add("https://raw.githubusercontent.com/kargig/greek-adblockplus-filter/master/void-gr-filters.txt");
            urlList.add("https://raw.githubusercontent.com/hufilter/hufilter/master/hufilter-ublock.txt");
            urlList.add("https://raw.githubusercontent.com/heradhis/indonesianadblockrules/master/subscriptions/abpindo.txt");
            urlList.add("https://easylist-downloads.adblockplus.org/indianlist.txt");
            urlList.add("https://raw.githubusercontent.com/MasterKia/PersianBlocker/main/PersianBlocker.txt");
            urlList.add("https://adblock.gardar.net/is.abp.txt");
            urlList.add("https://raw.githubusercontent.com/easylist/EasyListHebrew/master/EasyListHebrew.txt");
            urlList.add("https://easylist-downloads.adblockplus.org/easylistitaly.txt");
            urlList.add("https://raw.githubusercontent.com/DeepSpaceHarbor/Macedonian-adBlock-Filters/master/Filters");
            urlList.add("https://filters.adtidy.org/ios/filters/7.txt");
            urlList.add("https://raw.githubusercontent.com/yous/YousList/master/youslist.txt");
            urlList.add("https://www.fanboy.co.nz/fanboy-korean.txt");
            urlList.add("https://raw.githubusercontent.com/EasyList-Lithuania/easylist_lithuania/master/easylistlithuania.txt");
            urlList.add("https://raw.githubusercontent.com/Latvian-List/adblock-latvian/master/lists/latvian-list.txt");
            urlList.add("https://easydutchcdn.pages.dev/EasyDutch.all.txt");
            urlList.add("https://raw.githubusercontent.com/DandelionSprout/adfilt/master/NorwegianList.txt");
            urlList.add("https://raw.githubusercontent.com/MajkiIT/polish-ads-filter/master/polish-adblock-filters/adblock.txt");
            urlList.add("https://raw.githubusercontent.com/olegwukr/polish-privacy-filters/master/anti-adblock.txt");
            urlList.add("https://raw.githubusercontent.com/olegwukr/polish-privacy-filters/master/anti-adblock-suplement.txt");
            urlList.add("https://raw.githubusercontent.com/tcptomato/ROad-Block/master/road-block-filters-light.txt");
            urlList.add("https://raw.githubusercontent.com/tcptomato/ROad-Block/master/road-ubo.txt");
            urlList.add("https://easylist-downloads.adblockplus.org/advblock.txt");
            urlList.add("https://raw.githubusercontent.com/easylist/ruadlist/master/js-fixes-experimental.txt");
            urlList.add("https://filters.adtidy.org/extension/ublock/filters/1.txt");
            urlList.add("https://easylist-downloads.adblockplus.org/bitblock.txt");
            urlList.add("https://easylist-downloads.adblockplus.org/easylistspanish.txt");
            urlList.add("https://filters.adtidy.org/extension/ublock/filters/9.txt");
            urlList.add("https://raw.githubusercontent.com/betterwebleon/slovenian-list/master/filters.txt");
            urlList.add("https://raw.githubusercontent.com/lassekongo83/Frellwits-filter-lists/master/Frellwits-Swedish-Filter.txt");
            urlList.add("https://raw.githubusercontent.com/easylist-thailand/easylist-thailand/master/subscription/easylist-thailand.txt");
            urlList.add("https://filters.adtidy.org/extension/ublock/filters/13.txt");
            urlList.add("https://raw.githubusercontent.com/abpvn/abpvn/master/filter/abpvn_ublock.txt");
            urlList.add("https://raw.githubusercontent.com/brave/adblock-lists/master/brave-lists/experimental.txt");
