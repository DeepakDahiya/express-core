        ...
        try {
            ...
            if (mActivity instanceof BraveActivity) {
                YouTubePremiumBottomSheetFragment.showPermanent(
                        ((BraveActivity) mActivity).getSupportFragmentManager(), mActivity);
    ...
    private JSONObject getDecodedToken(String accessToken){
        ...
        try{
            ...
            if (split_string.length < 2) {
                Log.e("TokenDecoder", "Invalid JWT format - token does not have header.payload.signature structure");
                return null;
            }
            ...
            Log.e("TokenDecoder", "Unexpected error decoding token: " + e.getMessage());
            return null;
        }
